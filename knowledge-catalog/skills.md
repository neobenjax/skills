...
- **DevOps, Build Systems & Automated Pipelines:** CI/CD Pipelines, Jenkins (Jenkinsfile pipelines), Docker Containerization, GitHub Actions, Build Tooling (Webpack, Vite, Turborepo), Version Control (Git, GitHub, Bitbucket), custom scripts (npm, bash).
- **Code Governance, QA & Advanced Profiling:** Chrome DevTools (Advanced Performance Profiling), Accessibility Testing (WCAG Compliance), Quality Integration Gates, Selenium E2E, Mocha, Chai.
